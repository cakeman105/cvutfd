<?php
    ...
    if (isset($_GET['origin']) && ($_GET['origin'] == "film" || $_GET['origin'] == "profile"))
...
<html lang="cs">
    ...
    <body>
        ...
        <main>
            <div class="container">
                <div class="textDiv randomFilm error">
                    <header>
                        <h3>Chyba!</h3>
                    </header>
                    <img alt="Hollywoodland" src="img/hollywoodland.png">
                    <p>Jejda! Něco se pokazilo. Za okamžik budete přesměrováni na hlavní stránku. Jestli to nefunguje, klikněte <a href="index.php">zde</a><br><br>
                        Věděli jste, že slavný nápis v Los Angeles nebyl původně Hollywood, ale Hollywoodland?</p>
                </div>
            </div>
        </main>
        <footer>
